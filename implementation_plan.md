...
@utility section-padding { @apply py-16 lg:py-24; }
@utility card-base { @apply rounded-2xl border border-gray-200 dark:border-navy-700 bg-white dark:bg-navy-800 p-6 shadow-sm; }
@utility btn-primary { @apply inline-flex items-center px-6 py-3 bg-primary-600 text-white font-semibold rounded-xl hover:bg-primary-700 transition-all shadow-lg shadow-primary-600/20; }
@utility btn-secondary { @apply inline-flex items-center px-6 py-3 border border-gray-200 dark:border-navy-600 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-navy-750 transition-all; }
```
